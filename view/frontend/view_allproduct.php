      ...
      <div class="container_fullwidth">
        <div class="container">
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="price-filter leftbar">
                <h3 class="title">
                  ...
                  <label>
                      <a href="san-pham/tim-kiem/0k-1000k"><button style="width:230px;">Từ 0k - 10000k</button></a>
                     ...
                     <a href="san-pham/tim-kiem/8000k-10000k"> <button style="width:230px;">Từ 8000k - 10triệu </button></a>
                      <a href="san-pham/tim-kiem/hon10tr"><button style="width:230px;">Trên 10triệu</button></a>
                  </label>
            ...
            {
                 ?>
                    <a href="trang-san-pham/trang/<?php echo $i; ?>">
                      <?php echo $i; ?>
                    </a>
                <?php } ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6">
                    <div class="products">
                      <div class="thumbnail">
                        <a href="san-pham/chi-tiet/<?php echo $rows->pk_product_id; ?>/<?php echo remove_unicode($rows->c_name); ?>">
