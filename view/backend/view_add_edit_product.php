...
<?php echo isset($arr->c_content)?$arr->c_content:""; ?>								
					...
					<div class="form-gruop">
						<div class="row">
							...
							<div class="col-md-10">
	<input type="number" value="<?php echo isset($arr->c_price)?$arr->c_price:"";  ?>" name="c_price"> 
							</div>
						</div>
						</div>
					</div>
					<div class="form-gruop">
						<div class="row">
							<div class="col-md-2 text-right">Giảm giá:</div>
							<div class="col-md-10">
	<input type="number" value="<?php echo isset($arr->c_sale)?$arr->c_sale:"";  ?>" name="c_sale"> %
							</div>
						</div>
						</div>
										<!-- form group -->
