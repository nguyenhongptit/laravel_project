					...
					<form method="post" action="">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-9">
									<input type="submit" value="Login" class="btn btn-primary"> <input type="Reset" value="Reset" class="btn btn-danger"> 	<button value="Đăng ký" class="btn btn-primary"><a style="color: white;" href="register.php">Đăng Ký</a></button>   
								</div>
							</div>
						</div>
						<!-- end form group -->
