			...
			<div class="card card-header bg-primary text-white" style="padding:7px !important;">Login</div>
				...
				<table class="table table-hover table-bordered">
					<tr>
						...
						<th style="width: 120px;">Loại tin tức</th>
					...
					<?php 
					 ...
					 ?>
					<tr>
						<td><?php echo isset($row->pk_category_news_id)?$row->pk_category_news_id:""; ?></td><td><?php echo isset($row->c_name)?$row->c_name:""; ?></td> <td><a href="admin.php?controller=add_edit_category_news&act=edit&id=<?php echo $row->pk_category_news_id; ?>">Sửa</a> <a href="admin.php?controller=add_edit_category_news&act=delete&id=<?php echo $row->pk_category_news_id; ?>">Xóa</a> </td>
					</tr>
					<?php endforeach; ?>
				</table>
				<!-- end table -->
