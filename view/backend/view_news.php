			...
			<div class="card card-header bg-primary text-white" style="padding:7px !important;">Login</div>
				...
				<table class="table table-hover table-bordered">
					<tr>
						...
						<th style="width: 120px;">TT Nổi bật</th>
...
<?php 
 ...
 ?>
						...
						<td style='text-align: center;'>
							<?php $category = $this->model->get_a_record("select c_name from tbl_category_news where pk_category_news_id=".$rows->fk_category_news_id); 
							echo isset($category->c_name)?$category->c_name:"";
							?>
