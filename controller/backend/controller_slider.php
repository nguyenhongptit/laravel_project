<?php 
	class controller_slider{
		...
		public function __construct(){
			...
			$total = $this->model->num_rows("select c_name from tbl_slider");
			...
			//------------
			$arr = $this->model->get_all("select * from tbl_slider order by pk_slider_id desc limit $from,$record_per_page");
			//load view
			include "view/backend/view_slider.php";
			//------------
		}
	}
