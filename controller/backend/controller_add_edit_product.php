		...
		public function __construct(){
			...
			switch($act){
				...
				case "do_edit":
					...
					//edit ban ghi
					$this->model->execute("update tbl_product set c_name='$c_name',c_description='$c_description',c_content='$c_content',fk_category_product_id=$fk_category_product_id,c_price=$c_price,c_sale=$c_sale where pk_product_id=$id");					
					//upload image
					$c_img = "";
				...
				case "do_add":
					...
					$this->model->execute("insert into tbl_product(c_name,c_description,fk_category_product_id,c_content,c_img,c_price,c_sale,c_count) values('$c_name','$c_description','$fk_category_product_id','$c_content','$c_img','$c_price','$c_sale',0)");
					//------------
					//quay lai trang tin tuc
					header("location:admin.php?controller=product");
				break;
